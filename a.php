<html>
<style>
#td1{color:black;margin-left:00px;margin-top:20px;width:300px;height:200px}
...
$con=mysql_connect("localhost","root","44422");
mysql_select_db("portal",$con);
$sql=mysql_query("select factost from notice where adtofac='' && adtost=''");
...
for($i=0;$i<$numrows1;$i++)
 ...
 {
  echo '<tr style="background-color:white"><h3><td id="td1">'.$row['factost'].'</h3>';
  }
  }
 }
?></div>
